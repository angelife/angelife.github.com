...
- 当前版本：v0.7.16
- 最新 commit：`ad754a7`（Hugo 全站重建，83篇封面图+五行分类完整）
- 最新 tag：`v0.7.16`
- 线上状态：v0.7.16 构建中（GitHub Pages）

### v0.7.16 发布内容

- 全站 83 篇 post 配图覆盖（原有封面保留 + 批量生成 73 张新图）
- 五行分类体系最终补全（最后一篇 `2014-04-16-ref2` 补分类）
- Hugo v0.147.0 全站重建（427 页）
- README 版本更新（v0.7.14 → v0.7.16）
