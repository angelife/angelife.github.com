...
写新文章前先检查是否有内容相似的已有文章。

**处理策略：**

- **内容高度相似或重叠** → 优先合并到已有文章，而不是发布新篇
- **主题相关但角度不同** → 内容关联（文内链接 + tags/series 归类）
- **判断标准**：看是否有独立的长期价值；重复内容不堆砌，宁精不滥

**合并方式：**
- 在旧文中补充新角度或新论断，保留原 URL 和 slug
- 如必须新建，删除或归档旧文，避免内容碎片化
